...
<html lang="en">
<head>
    <title>BarForum search results</title>
    <meta charset="utf-8">
    <meta charset="utf-8">
...
<div class="container" style="margin-top:50px">
      ...
      <div class="col-sm-9">
        <table class="table" id = "posts_table">
          <!--ומכניס נתונים-->
            ...
            <caption><h2 style="text-align:center">  תוצאות חיפוש: <? echo $search ?> </h2></caption>
            <tr class="success">
 ...
 <?php
			...
			WHERE (`post_title` LIKE '%".$search."%') OR (`post_data` LIKE '%".$search."%')");
